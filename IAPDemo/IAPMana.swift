...
class IAPHelper: NSObject {
    ...
    override convenience init() {
        self.init(productIds: [Constant.rubyProductIdentifier, Constant.giantRubyProductIdentifier, Constant.autoRubyProductIdentifier, Constant.nonAutoRubyProductIdentifier])
    }
